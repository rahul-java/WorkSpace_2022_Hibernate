...
<tr><td><%=f.getFid() %></td><td><%=f.getAcctno() %></td><td><%=f.getName() %></td><td><%=f.getDob() %></td><td><%=f.getGndr() %></td><td><%=f.getStCode() %></td><td><%=f.getDistCode() %></td></tr>
...
%>
<tr><td><%= c.getCid() %></td><td><%= c.getName() %></td><td><%= c.getAdhar() %></td><td><%=c.getAge() %></td><td><%= f.getFid() %></td></tr>
 <% 
